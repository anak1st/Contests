...
//    cin.tie(0);cout.tie(0);
    ...
    while(t--)
    {
        ...
        {
            double r01=sqrt(r1*r1-a*a/4.0)-a/2.0;
            double r02=sqrt(r2*r2-a*a/4.0)-a/2.0;
            c[1]=circle(Point(x1,y1),r01);
            c[2]=circle(Point(x2,y2),r02);
            double ans1=c[1].areacircle(c[2]);
            double ans2=c[1].area();
